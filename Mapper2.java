...
//	private Text date_Views = new Text(); // value
//	private Text videoID = new Text(); // value
//	
//	
//	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
//		
...
//				
//				videoID.set(attributes[0]); // set country name as key
//				
//				//country.set(attributes[attributes.length-1]); // set country name as key
//				date_Views.set(attributes[8]+"|" +attributes[1]);// set videoID, trending date , total views as value
//
//				 context.write(videoID, date_Views);
